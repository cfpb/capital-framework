...
// .m-form-field
@form-field-border:                 @input-border;
@form-field-border__focused:        @input-border;
@form-field-border__selected:       @pacific;
@form-field-border__disabled:       @gray-60;

// .m-form-field__lg-target
@form-field-lg-target-bg:           @gray-10;
@form-field-lg-target-bg__selected: @pacific-20;
@form-field-lg-target-bg__disabled: @gray-20;
@form-field-lg-target-border:       @pacific;
