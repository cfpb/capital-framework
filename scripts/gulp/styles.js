...
function stylesCf() {
  return gulp
    .src('./src/capital-framework-with-grid.less')
    .pipe(
      gulpLess({
...
function stylesGrid() {
  return gulp
    .src('./src/cf-grid/src-generated/*.less')
    .pipe(
      gulpLess({
        paths: ['node_modules/cf-*/src/']
      })
...
gulp.task(
  'styles',
  gulp.parallel('styles:cf', 'styles:components', 'styles:grid')
);
