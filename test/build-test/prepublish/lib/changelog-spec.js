...
const fixturesPath = path.join( rootPath, 'test', 'build-test', 'prepublish', 'fixtures' );
...
const changelogExpected = fs.readFileSync( fixturesPath + '/changelog-expected.md', 'utf8' );
