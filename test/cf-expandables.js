(function($) {
  ...
  asyncTest(
    'Verify expandables can open after being closed by default',
    function() {
      expect(3);
  ...
  asyncTest(
    'Verify expandables can close after being opened by a click',
    function() {
      expect(3);
      var $expandable = this.$testSubjectOne;
  ...
  asyncTest(
    'Verify expandables can close after being open by default',
    function() {
      expect(3);
  ...
  asyncTest(
    'Verify expandables can open after being closed by a click',
    function() {
      expect(3);
      var $expandable = this.$testSubjectTwo;
      // This expandable was opened in the previous test
  ...
  test(
    'Verify initial default collapsed state of expandables ' + 'within a group',
    function() {
      expect(6);
  ...
  asyncTest(
    'Verify expandables within a group can open after being ' +
  ...
  asyncTest(
    'Verify expandables within a group can close after being ' +
