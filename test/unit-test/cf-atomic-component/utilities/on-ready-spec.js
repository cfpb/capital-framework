...
describe('on-ready', function() {
  ...
  it('should return early if passed a string', function() {
  ...
  it(
    'should add a function to the saved array and trigger it' +
    ...
    function() {
      ...
      return triggerReadyState(DOCUMENT_STATES.COMPLETE).then(function() {
  ...
  it(
    'should add a function to the saved array but not trigger it' +
      'if state is loading',
    ...
    function() {
      ...
      return triggerReadyState(DOCUMENT_STATES.LOADING).then(function() {
        expect(typeof _readyFunctions).to.equal('object');
        expect(_readyFunctions.length).to.equal(2);
      });
    }
